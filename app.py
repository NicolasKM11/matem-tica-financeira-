...
st.set_page_config(page_title="matemática financeira v6", page_icon="⌚", layout="centered")
...
.watch-mode div[data-testid="stMetricValue"] {
    font-size: 1.05rem !important;
}
.watch-mode div[data-testid="stMetricLabel"] {
    font-size: 0.72rem !important;
}
.watch-mode input, .watch-mode select, .watch-mode textarea {
    font-size: 0.82rem !important;
}
...
.watch-mode pre, .watch-mode code {
    font-size: 0.72rem !important;
...
if st.session_state.watch_mode:
    st.markdown('<div class="big-note">⌚ modo smartwatch ligado</div>', unsafe_allow_html=True)
else:
    st.markdown('<div class="big-note">💻 modo normal</div>', unsafe_allow_html=True)
